			...
			map = <div>
				...
				/>
					<div className="form-group">
						...
						<input type="text" name="area" className="form-control" onChange={ this.onChange } readOnly="readOnly" value={ location1[0] }/>
					</div>
					<div className="form-group">
						<label htmlFor="">Location 2:</label>
						<input type="text" name="area" className="form-control" onChange={ this.onChange } readOnly="readOnly" value={ location2[0] }/>
					</div>
					<div className="form-group">
						<input type="text" name="area" className="form-control" onChange={ this.onChange } readOnly="readOnly" value={ errrr }/>
					</div>
					<button class="btn btn-primary" onClick={this.onButtonClick}>Izdračunaj</button>
				</div>
